---
slug: recover-after-bad-fight
title: "Rogue Command Recovery Guide: What to Fix First After a Bad Fight"
...
This guide helps players recover after one fight goes wrong. The first priority is not revenge. It is stabilizing the part of the run that just became vulnerable: Engineer safety, harvesting, key unit roles, or reward direction.
...
1. Re-establish Engineer safety.
2. Protect or restore harvesting.
3. Replace the role the army lost.
4. Draft the next reward around the failure you just saw.
