---
slug: blueprint-drafting-mistakes
title: "Rogue Command Blueprint Drafting Mistakes: When a New Tool Makes the Run Worse"
category: systems
patchVersion: "1.0"
...
This guide helps players decide when a Blueprint actually improves a run. The fast answer is simple: take a new Blueprint when the current army is missing a job you can afford to support soon, and skip it when the new line would only make the base more complicated.
...
2. Can I build or support it before the next important fight?
3. What current spending does it delay?
4. If I skip it, does the run still have a stable answer?
