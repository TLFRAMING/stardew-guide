---
slug: "defense-readiness-before-raids"
title: "Nova Roma Defense Readiness Guide: Prepare Before Raids Expose The City"
...
1. What is the new exposed side of the city?
2. Which support system sits closest to that side?
3. Can workers and supplies move safely if pressure arrives?
4. Would losing this area break a chain somewhere else?
5. Is this expansion worth defending right now?
...
2. Restore the support system that keeps the city alive.
3. Reconnect storage and production if routing changed.
4. Recheck labor before rebuilding everything.
5. Only then add new city edge or housing.

If the aftermath looks like an economy problem, use the [resource shortage guide](/nova-roma/guides/early-resource-shortage-guide) to trace the pressure backward.
